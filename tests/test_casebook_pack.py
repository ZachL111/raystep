"""Regression checks for the raystep casebook."""
...
from casebook.harness import assert_expected, raystep_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(raystep_summary(), assert_expected())
